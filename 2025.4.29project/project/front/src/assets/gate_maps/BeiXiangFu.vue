<template>
  <div class="map-container">
    ...
    <svg width="100%" height="100%" viewBox="0 0 800 506" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- 支流 - 后场港 -->
      <path 
        transform="rotate(-22.2337 366.323 298.642)"
        d="m270.3161,268.64229c21.3349,10 42.6698,-10 64.00469,10c21.33491,20 42.66981,0 64.0047,20c21.3349,20 42.6698,0 64.0047,20l0,10c-21.3349,-20 -42.6698,0 -64.0047,-20c-21.33489,-20 -42.6698,0 -64.0047,-20c-21.33489,-20 -42.6698,0 -64.00469,-10l0,-10z"
        fill="url(#riverGradient)"
        stroke="#3da0db"
        stroke-width="1"
      />
